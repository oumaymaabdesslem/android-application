...
import info.android.myapplication.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(Prevelant.currentOnlineUser.getImage()).placeholder(R.drawable.profile).into(ImageView);
   ...
   //affichage des produits en utilisant recyclerview
