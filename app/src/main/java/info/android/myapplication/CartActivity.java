...
import info.android.myapplication.ViewHolder.CartViewHolder;
import info.android.myapplication.model.Cart;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter =new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final CartViewHolder cartViewHolder, int i, @NonNull final Cart cart) {
                cartViewHolder.cartproductname.setText("Name = " + cart.getPname());
                cartViewHolder.cartproductprice.setText("Price = " +cart.getPrice());
                cartViewHolder.cartproductquantity.setText( "Quantity = " +cart.getQuantity());
